...
function updateProfileUI(user) {
    ...
    badge.className = "absolute -bottom-2 -right-2 px-3 py-1 text-[10px] font-bold rounded-full border-2 border-[#050505] uppercase tracking-tighter text-white";
    
    if (user.role === 'admin') {
        badge.innerText = 'ADMIN';
        badge.classList.add('bg-red-500');
    } else if (user.role === 'reseller') {
        badge.innerText = 'RESELLER PRO';
